...
const PrivacyPolicy = () => {
    return (
        <div className="mx-auto px-4 py-12 sm:px-6 lg:px-16 bg-white text-black">
            <h1 className="text-4xl font-semibold text-center mb-8 mt-10">Privacy Policy</h1>
            <p className="text-center text-black">Last updated: 09/09/25</p>
